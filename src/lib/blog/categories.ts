...
export const BLOG_CATEGORIES: { key: BlogCategoryKey; labels: Record<Locale, string> }[] = [
  { key: 'events',     labels: { en: 'Events',     es: 'Eventos',     ar: 'فعاليات', it: 'Eventi' } },
  { key: 'gastronomy', labels: { en: 'Gastronomy', es: 'Gastronomía', ar: 'مأكولات', it: 'Gastronomia' } },
  { key: 'places',     labels: { en: 'Places',     es: 'Lugares',     ar: 'أماكن',   it: 'Luoghi' } },
  { key: 'monuments',  labels: { en: 'Monuments',  es: 'Monumentos',  ar: 'معالم',   it: 'Monumenti' } },
  { key: 'beaches',    labels: { en: 'Beaches',    es: 'Playas',      ar: 'شواطئ',   it: 'Spiagge' } },
  { key: 'sports',     labels: { en: 'Sports',     es: 'Deportes',    ar: 'رياضة',   it: 'Sport' } },
  { key: 'guides',     labels: { en: 'Guides',     es: 'Guías',       ar: 'أدلة',    it: 'Guide' } },
]

export const ALL_LABEL: Record<Locale, string> = { en: 'All', es: 'Todos', ar: 'الكل', it: 'Tutti' }
