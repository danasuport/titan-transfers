...
export const country = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'airports', title: 'Airports', type: 'array', of: [{ type: 'reference', to: [{ type: 'airport' }] }] }),
    defineField({ name: 'cities', title: 'Cities', type: 'array', of: [{ type: 'reference', to: [{ type: 'city' }] }] }),
    defineField({ name: 'regions', title: 'Regions', type: 'array', of: [{ type: 'reference', to: [{ type: 'region' }] }] }),
    defineField({
      name: 'translations',
      title: 'Translations',
      type: 'object',
