...
export function StickyHelp() {
  ...
  const label = pick(locale, { en: 'Help', es: 'Ayuda', ar: 'مساعدة', it: 'Aiuto', de: 'Hilfe', fr: 'Aide' })
  ...
  const options = [
    ...
    {
      key: 'phone',
      label: pick(locale, { en: 'Phone', es: 'Teléfono', ar: 'الهاتف', it: 'Telefono', de: 'Telefon', fr: 'Téléphone' }),
      href: PHONE,
      bg: '#242426',
      hoverBg: '#8BAA1D',
      icon: (
