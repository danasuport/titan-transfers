  ...
  return (
    <div style={{
          ...
          {options.map(opt => (
            <a
              ...
              onMouseLeave={e => {
                ...
                ;(e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 4px 14px rgba(0,0,0,0.2)'
              }}
            >
              <span style={{
      ...
      <button
        ...
        onMouseEnter={e => (e.currentTarget.style.boxShadow = '0 6px 22px rgba(0,0,0,0.38)')}
        onMouseLeave={e => (e.currentTarget.style.boxShadow = '0 4px 16px rgba(0,0,0,0.28)')}
        aria-label={label}
      >
        {/* Green circle icon */}
        <span style={{
          ...
          {open ? (
            ...
            <svg width="30" height="30" viewBox="0 0 55 56" fill="none">
        ...
        <span style={{ color: '#ffffff', fontSize: '1rem', fontWeight: 600, paddingLeft: '0.75rem' }}>
          {label}
        </span>
      </button>
