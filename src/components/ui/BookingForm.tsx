...
export function BookingForm() {
  ...
  function buildUrl() {
    ...
    //   r1ls = pickup location
    //   r1le = drop-off location
    //   r1d  = date "YYYY-MM-DD HH:MM"
    //   pax / lug are passed through but ETO may ignore them at the URL level
    //   (they're asked for inside the wizard).
