        ...
        <div className="footer-main-grid" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 0.9fr', gap: '3rem', marginBottom: '3rem' }}>
          ...
          <div className="footer-brand-col">
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              {[
                ...
                <a key={label} href="#" aria-label={label} style={{ width: '42px', height: '42px', background: '#242426', display: 'flex', alignItems: 'center', justifyContent: 'center', transform: 'skewX(-12deg)', transition: 'background 0.2s' }}
          ...
          <AccordionCol title={locale === 'es' ? 'Opiniones' : 'Reviews'}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {[
                { href: 'https://es.trustpilot.com/review/titantransfers.net', name: 'Trustpilot', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="#00B67A"><path d="M12 0l3.09 9.26H24l-7.85 5.7 3.09 9.26L12 18.52l-7.24 5.7 3.09-9.26L0 9.26h8.91z"/></svg>, starColor: '#00B67A', score: `4.9 / 5 · +500 ${locale === 'es' ? 'opiniones' : 'reviews'}` },
                { href: 'https://www.trustedshops.com/buyerrating/info_PLACEHOLDER.html', name: 'Trusted Shops', icon: <Image src="/logo-trusted-shops.png" alt="Trusted Shops" width={16} height={16} style={{ objectFit: 'contain' }} />, starColor: '#FFDC0F', score: `4.9 / 5 · +1.800 ${locale === 'es' ? 'opiniones' : 'reviews'}` },
                { href: 'https://g.page/r/PLACEHOLDER/review', name: 'Google', icon: <Image src="/logo-google.svg" alt="Google" width={16} height={16} style={{ objectFit: 'contain' }} />, starColor: '#FBBC05', score: `4.8 / 5 · +100 ${locale === 'es' ? 'opiniones' : 'reviews'}` },
