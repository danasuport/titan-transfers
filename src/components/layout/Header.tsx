      ...
      <div style={{ paddingLeft: '6vw', paddingRight: '6vw', paddingTop: '1rem', paddingBottom: '1rem' }}>
          ...
          <div className="flex h-20 items-center gap-4">
            ...
            <div className="ml-auto flex items-center gap-3">
              ...
              >
                ...
                <span style={{ transform: 'skewX(12deg)', display: 'inline-block' }}>{pick(locale, { en: 'Login', es: 'Acceder', ar: 'دخول', it: 'Accedi', de: 'Anmelden', fr: 'Connexion' })}</span>
              </Link>
            </div>
          </div>
        ...
        <div className="lg:hidden">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <LanguageSwitcher />
            <Link href="/login/"
              aria-label={pick(locale, { en: 'Login', es: 'Acceder', ar: 'دخول', it: 'Accedi', de: 'Anmelden', fr: 'Connexion' })}
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 300, display: 'flex', flexDirection: 'column', background: '#ffffff' }}>
          ...
          <div style={{ flexShrink: 0, borderTop: '1px solid #e5e7eb', padding: '1rem 6vw', display: 'flex', gap: '1rem', alignItems: 'center' }}>
            ...
            <Link href="/login/" onClick={() => setMobileMenuOpen(false)}
              ...
              {pick(locale, { en: 'Login', es: 'Acceder', ar: 'دخول', it: 'Accedi', de: 'Anmelden', fr: 'Connexion' })}
            </Link>
          </div>
        </div>
      )}
