    ...
    <section className="bg-white py-16 lg:py-20">
      <div className="site-container">
        ...
        <div style={{
          ...
          {/* ── Left: Image — PNG already has diagonal montage built in ── */}
          ...
          {/* ── Right: Content ── */}
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '3rem 3rem 3rem 4rem' }}>
            {/* Stat label */}
            <div style={{ fontSize: '0.8rem', fontWeight: 700, color: '#8BAA1D', marginBottom: '0.75rem' }}>
              {slide.stat}
            </div>
            ...
            {/* CTA Button — square, no border radius */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
              <SkewButton href={`/${href.replace(/^\//, '')}`} variant="primary">{tCommon('learnMore')}</SkewButton>

            </div>

            {/* Carousel strip-dots — bottom right, positioned absolute */}
            <div style={{
              position: 'absolute',
              bottom: '1.5rem',
              right: '2.5rem',
