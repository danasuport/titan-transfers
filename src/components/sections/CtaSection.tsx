        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="cta-top-block" style={{ flex: 1, padding: '3.5rem 5vw 3rem 4vw' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', marginBottom: '2rem', flexWrap: 'wrap' }}>
              {[
                pick(locale, { en: 'Fixed price', es: 'Precio fijo', ar: 'سعر ثابت' }),
                pick(locale, { en: '24/7 support', es: 'Soporte 24/7', ar: 'دعم على مدار الساعة' }),
                pick(locale, { en: 'Secure payment', es: 'Pago seguro', ar: 'دفع آمن' }),
              ].map(label => (
            ...
            <div className="cta-buttons-row" style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
              <SkewButton href="/#booking" variant="primary" style={{ fontSize: '0.85rem', padding: '0.6rem 1.1rem' }}>
                {pick(locale, { en: 'Book transfer', es: 'Reservar transfer', ar: 'احجز رحلتك' })}
              </SkewButton>
              <SkewButton href={contactHref} variant="outline" style={{ fontSize: '0.85rem', padding: '0.6rem 1.1rem' }}>
                {pick(locale, { en: 'Contact us', es: 'Contáctanos', ar: 'تواصل معنا' })}
              </SkewButton>
            </div>
          </div>
