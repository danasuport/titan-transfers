          ...
          <p style={{ fontSize: '0.9rem', color: '#64748b', maxWidth: '700px', margin: '0 auto', lineHeight: 1.7 }}>
            {locale === 'es'
              ? <>Reserva tu transfer privado desde el aeropuerto en{' '}
                  <Link href={'/city/barcelona/' as any} style={{ color: '#8BAA1D', textDecoration: 'none', fontWeight: 500 }}>Barcelona</Link>,{' '}
                  <Link href={'/city/london/' as any} style={{ color: '#8BAA1D', textDecoration: 'none', fontWeight: 500 }}>Londres</Link>,{' '}
                  <Link href={'/city/paris/' as any} style={{ color: '#8BAA1D', textDecoration: 'none', fontWeight: 500 }}>París</Link>,{' '}
                  <Link href={'/city/dubai/' as any} style={{ color: '#8BAA1D', textDecoration: 'none', fontWeight: 500 }}>Dubái</Link>{' '}
              ...
              : <>Book your private airport transfer in{' '}
                  <Link href={'/city/barcelona/' as any} style={{ color: '#8BAA1D', textDecoration: 'none', fontWeight: 500 }}>Barcelona</Link>,{' '}
                  <Link href={'/city/london/' as any} style={{ color: '#8BAA1D', textDecoration: 'none', fontWeight: 500 }}>London</Link>,{' '}
                  <Link href={'/city/paris/' as any} style={{ color: '#8BAA1D', textDecoration: 'none', fontWeight: 500 }}>Paris</Link>,{' '}
                  <Link href={'/city/dubai/' as any} style={{ color: '#8BAA1D', textDecoration: 'none', fontWeight: 500 }}>Dubai</Link>{' '}
