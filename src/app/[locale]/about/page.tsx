...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    alternates: staticPageAlternates('/about/', locale),
    title: pick(locale, {
  ...
  const body = {
    ...
    values: [
      pick(locale, {
        ...
        it: ['Affidabilità', 'Monitoriamo tutti i voli e adattiamo automaticamente gli orari di ritiro'] as const,
        de: ['Zuverlässigkeit', 'Wir überwachen alle Flüge und passen die Abholzeiten automatisch an'] as const,
      }),
      pick(locale, {
        ...
        it: ['Trasparenza', 'Prezzi fissi senza costi nascosti'] as const,
        de: ['Transparenz', 'Festpreise ohne versteckte Kosten'] as const,
      }),
      pick(locale, {
        ...
        it: ['Comfort', 'Veicoli moderni e climatizzati'] as const,
        de: ['Komfort', 'Moderne, klimatisierte Fahrzeuge'] as const,
      }),
      pick(locale, {
        ...
        it: ['Servizio', 'Autisti professionisti che parlano inglese'] as const,
        de: ['Service', 'Professionelle, Englisch sprechende Fahrer'] as const,
      }),
    ],
  }
