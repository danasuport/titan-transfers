...
export default async function SitemapPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const labels = {
    title: pick(locale, { en: 'Sitemap', es: 'Mapa del sitio', ar: 'خريطة الموقع', it: 'Mappa del sito' }),
    ...
    sectMain: pick(locale, { en: 'Main pages', es: 'Páginas principales', ar: 'الصفحات الرئيسية', it: 'Pagine principali' }),
    sectAirports: pick(locale, { en: 'Airports', es: 'Aeropuertos', ar: 'المطارات', it: 'Aeroporti' }),
    sectRoutes: pick(locale, { en: 'Routes from airports', es: 'Rutas desde aeropuertos', ar: 'مسارات من المطارات', it: 'Percorsi dagli aeroporti' }),
    sectCities: pick(locale, { en: 'Cities', es: 'Ciudades', ar: 'المدن', it: 'Città' }),
    sectCountries: pick(locale, { en: 'Countries', es: 'Países', ar: 'الدول', it: 'Paesi' }),
    sectRegions: pick(locale, { en: 'Regions', es: 'Regiones', ar: 'المناطق', it: 'Regioni' }),
    sectBlog: pick(locale, { en: 'Blog', es: 'Blog', ar: 'المدونة', it: 'Blog' }),
    home: pick(locale, { en: 'Home', es: 'Inicio', ar: 'الرئيسية', it: 'Home' }),
    citiesNav: pick(locale, { en: 'Cities', es: 'Ciudades', ar: 'المدن', it: 'Città' }),
    countriesNav: pick(locale, { en: 'Countries', es: 'Países', ar: 'الدول', it: 'Paesi' }),
    regionsNav: pick(locale, { en: 'Regions', es: 'Regiones', ar: 'المناطق', it: 'Regioni' }),
    servicesNav: pick(locale, { en: 'Services', es: 'Servicios', ar: 'الخدمات', it: 'Servizi' }),
    contactNav: pick(locale, { en: 'Contact', es: 'Contacto', ar: 'تواصل معنا', it: 'Contatto' }),
    aboutNav: pick(locale, { en: 'About', es: 'Sobre nosotros', ar: 'من نحن', it: 'Chi siamo' }),
    faqNav: pick(locale, { en: 'FAQ', es: 'Preguntas frecuentes', ar: 'الأسئلة الشائعة', it: 'Domande frequenti' }),
    bookNav: pick(locale, { en: 'Book', es: 'Reservar', ar: 'احجز', it: 'Prenota' }),
    blogNav: pick(locale, { en: 'Blog', es: 'Blog', ar: 'المدونة', it: 'Blog' }),
  }
