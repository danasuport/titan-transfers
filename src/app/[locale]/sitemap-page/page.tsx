...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    ...
    title: pick(locale, {
      ...
      fr: 'Plan du site | Titan Transfers',
    }),
...
export default async function SitemapPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const labels = {
    title: pick(locale, { en: 'Sitemap', es: 'Mapa del sitio', ar: 'خريطة الموقع', it: 'Mappa del sito', de: 'Sitemap', fr: 'Plan du site' }),
    subtitle: pick(locale, {
      ...
      fr: 'Toutes les pages de Titan Transfers.',
    }),
    sectMain: pick(locale, { en: 'Main pages', es: 'Páginas principales', ar: 'الصفحات الرئيسية', it: 'Pagine principali', de: 'Hauptseiten', fr: 'Pages principales' }),
    sectAirports: pick(locale, { en: 'Airports', es: 'Aeropuertos', ar: 'المطارات', it: 'Aeroporti', de: 'Flughäfen', fr: 'Aéroports' }),
    sectRoutes: pick(locale, { en: 'Routes from airports', es: 'Rutas desde aeropuertos', ar: 'مسارات من المطارات', it: 'Percorsi dagli aeroporti', de: 'Routen von Flughäfen', fr: 'Itinéraires depuis les aéroports' }),
    sectCities: pick(locale, { en: 'Cities', es: 'Ciudades', ar: 'المدن', it: 'Città', de: 'Städte', fr: 'Villes' }),
    sectCountries: pick(locale, { en: 'Countries', es: 'Países', ar: 'الدول', it: 'Paesi', de: 'Länder', fr: 'Pays' }),
    sectRegions: pick(locale, { en: 'Regions', es: 'Regiones', ar: 'المناطق', it: 'Regioni', de: 'Regionen', fr: 'Régions' }),
    sectBlog: pick(locale, { en: 'Blog', es: 'Blog', ar: 'المدونة', it: 'Blog', de: 'Blog', fr: 'Blog' }),
    home: pick(locale, { en: 'Home', es: 'Inicio', ar: 'الرئيسية', it: 'Home', de: 'Startseite', fr: 'Accueil' }),
    citiesNav: pick(locale, { en: 'Cities', es: 'Ciudades', ar: 'المدن', it: 'Città', de: 'Städte', fr: 'Villes' }),
    countriesNav: pick(locale, { en: 'Countries', es: 'Países', ar: 'الدول', it: 'Paesi', de: 'Länder', fr: 'Pays' }),
    regionsNav: pick(locale, { en: 'Regions', es: 'Regiones', ar: 'المناطق', it: 'Regioni', de: 'Regionen', fr: 'Régions' }),
    servicesNav: pick(locale, { en: 'Services', es: 'Servicios', ar: 'الخدمات', it: 'Servizi', de: 'Dienstleistungen', fr: 'Services' }),
    contactNav: pick(locale, { en: 'Contact', es: 'Contacto', ar: 'تواصل معنا', it: 'Contatto', de: 'Kontakt', fr: 'Contact' }),
    aboutNav: pick(locale, { en: 'About', es: 'Sobre nosotros', ar: 'من نحن', it: 'Chi siamo', de: 'Über uns', fr: 'À propos' }),
    faqNav: pick(locale, { en: 'FAQ', es: 'Preguntas frecuentes', ar: 'الأسئلة الشائعة', it: 'Domande frequenti', de: 'FAQ', fr: 'FAQ' }),
    bookNav: pick(locale, { en: 'Book', es: 'Reservar', ar: 'احجز', it: 'Prenota', de: 'Buchen', fr: 'Réserver' }),
    blogNav: pick(locale, { en: 'Blog', es: 'Blog', ar: 'المدونة', it: 'Blog', de: 'Blog', fr: 'Blog' }),
  }
